Algoritmo CalculoComisiones
	// Este programa calcula cuanto dinero obtendra un vendedor por concepto de comisiones por las tres ventas que realiza en el mes y 
	...
	// Mostramos el monto obtenido por concepto de comisiones y el sueldo total que recibira el vendedor en el mes por pantalla
	Escribir 'El monto obtenido por concepto de comisiones es: ', comisiones
	Escribir 'El sueldo total que recibira el vendedor en el mes es: ', sueldoTotal
FinAlgoritmo
