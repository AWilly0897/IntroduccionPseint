...
1. Descargar PSeInt desde su [página oficial](http://pseint.sourceforge.net).
2. Abrir el instalador una vez descargado. 
3. Seguir las instrucciones, aceptando los términos y eligiendo ubicación. 
4. Opción portable: Si prefieres no instalar, puedes USAR la versión portable ejecutando "wxPSeInt.exe". 
5. Una vez instalado, abrirlo desde el menú de inicio.
...
Los ejercicios están organizados por encuentros y tipos, permitiendo una práctica progresiva.

Estructura de los archivos
Los archivos tienen una nomenclatura específica para facilitar su identificación:

Ejemplo:
MiniGuia_E1_EJ2_nombre-del-algoritmo.psc → Encuentro Nº1 Ejercicio Nº2.

Ejemplo:
introPs_E2_EJ1_nombre-del-algoritmo.psc → Encuentro Nº2 Ejercicio Nº1.
...
Cada ejercicio contiene las instrucciones necesarias para su ejecución en PSeInt. 
Los archivos están preparados para ser revisados, ejecutados y probados paso a paso, permitiendo la verificación de posibles errores. Además, se ha implementado un corrector línea por línea, lo que facilita la depuración del código.
